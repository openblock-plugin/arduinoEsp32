...
export default {
    ...
    'extensions': {
        'en': {
            ...
            'arduinoEsp32.pins.setPwmOutput': 'set pwm pin [PIN] out [OUT]',
            'arduinoEsp32.pins.setDACOutput': 'set dac pin [PIN] out [OUT]',
            'arduinoEsp32.pins.readDigitalPin': 'read digital pin [PIN]',
            'arduinoEsp32.pins.readAnalogPin': 'read analog pin [PIN]',
            'arduinoEsp32.pins.readTouchPin': 'read touch pin [PIN]',
            'arduinoEsp32.pins.setServoOutput': 'set servo pin [PIN] out [OUT]',
